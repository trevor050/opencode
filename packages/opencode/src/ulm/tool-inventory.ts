...
export const TOOL_INVENTORY_CATALOG: ToolInventorySpec[] = [
  ...
  { id: "gobuster", category: "web", purpose: "content, DNS, and vhost discovery", versionArgs: [["--version"]], install: [{ platform: "darwin", command: "brew install gobuster" }, { platform: "go", command: "go install github.com/OJ/gobuster/v3@latest" }], fallbacks: ["ffuf"] },
