...
async function ulmOperationContext(worktree: string, sessionID: SessionID | undefined) {
  ...
  return [
    ...
    "kickoff_stage_policy: pentest kickoff is staged: round1 time budget/autonomy first, tiny local/passive context, round2 scope/safety/credential/report questions, credential-vault review, Discovery Charter approval, duration-scaled charter research, then round3 discovery-informed follow-up questions",
    ...
    "planning_gate_policy: for pentest runs of 2h or more, ask scope questions until actionable, write a Discovery Charter for research/recon/questions/time investment, record approval, run the charter research pass, then write the full duration-aware operation_plan",
    ...
    "discovery_charter_policy: the Discovery Charter is not the final execution plan; it is the strategy for the first real research pass: what to learn, what to ask, what to recon, what evidence to record, and whether enough safe deep work exists to fill the budget",
    "charter_research_policy: approved-charter-without-full-plan means the next job is research, not scheduling broad execution; use tool inventory, external research, passive/basic recon, supervised active probes, evidence_record, operation_memory, and operation_checkpoint before final planning",
