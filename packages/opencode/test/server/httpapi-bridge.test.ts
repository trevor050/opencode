...
describe("HttpApi server", () => {
  ...
  test("covers every generated OpenAPI route with Effect HttpApi contracts", async () => {
    ...
    expect(effectRoutes.filter((route) => !honoRoutes.includes(route))).toEqual([
      ...
      "GET /ulm/operation/{operationID}/final-artifacts",
      "GET /ulm/operation/{operationID}/final-artifacts/{artifactID}",
      "GET /ulm/operation/{operationID}/resume",
      "GET /ulm/operation/{operationID}/status",
      "POST /api/session/{sessionID}/compact",
      "POST /api/session/{sessionID}/prompt",
      "POST /api/session/{sessionID}/wait",
      "POST /ulm/operation/close",
      "POST /ulm/operation/template",
      "POST /ulm/operation/{operationID}/audit",
      ...
      "POST /ulm/operation/{operationID}/daemon/start",
      "POST /ulm/operation/{operationID}/daemon/status",
      "POST /ulm/operation/{operationID}/daemon/stop",
      "POST /ulm/operation/{operationID}/final-artifacts/{artifactID}/open",
      "POST /ulm/operation/{operationID}/recover",
    ])
  })
