...
- Literal work proof counts both final daemon-heartbeat cycle data and package CLI launch records under `scheduler/cli-launches/`, because detached CLI model/command workers can survive heartbeat rewrites and daemon restarts.
